...
public class FrmEmpleadosBuscar extends javax.swing.JDialog {
     ...
     */
    public FrmEmpleadosBuscar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEmpleadosBuscar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmEmpleadosBuscar dialog = new FrmEmpleadosBuscar(new javax.swing.JFrame(), true);

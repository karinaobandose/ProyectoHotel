...
public class FrmServiciosBuscar extends javax.swing.JDialog implements Vista {
    ...
    public void showData() {
        ...
        if (this.controlador.getLista() != null) {
            Iterator<MServicio> iterator = this.controlador.getLista().iterator();
            while (iterator.hasNext()) {
                MServicio Servicio = iterator.next();

                Integer Codigo = Servicio.getCodigo();
                String Nombre = Servicio.getNombre();
                String Descripcion = Servicio.getDescripcion();
                Double Precio = Servicio.getPrecio();

                table.addRow(new Object[]{Codigo, Nombre, Descripcion, Precio});
            }
        }
    ...
    /**
     * Creates new form FrmServiciosBuscar
     */
    public FrmServiciosBuscar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Numero de codigo");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (this.tbListaHab.getRowCount() > 0 && this.tbListaHab.getSelectedRow() > -1) {
            Integer Codigo = ((Integer) this.tbListaHab.getValueAt(this.tbListaHab.getSelectedRow(), 0));
            String Nombre = (String) (this.tbListaHab.getValueAt(this.tbListaHab.getSelectedRow(), 1));

            String Descripcion = ((String) this.tbListaHab.getValueAt(this.tbListaHab.getSelectedRow(), 2));

            Double Precio = ((double) this.tbListaHab.getValueAt(this.tbListaHab.getSelectedRow(), 3));

            MServicio Servicio = new MServicio(Codigo, Nombre, Descripcion, Precio);
            this.controlador.setObjecto(Servicio);
            this.dispose();
        }
    ...
    private void txtFiltroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFiltroKeyReleased
        ...
        if (!filtro.isEmpty()) {
            ...
            try {
                ...
                Integer Codigo = this.controlador.getObjecto().getCodigo();
                String Nombre = this.controlador.getObjecto().getNombre();
                String Descripcion = this.controlador.getObjecto().getDescripcion();
                Double Precio = this.controlador.getObjecto().getPrecio();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmServiciosBuscar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmServiciosBuscar dialog = new FrmServiciosBuscar(new javax.swing.JFrame(), true);
